export const translations = {
  fr: {
    ...
    team: {
      ...
      members: [
        ...
        },
        {
          ...
          description:
            "Le président d'honneur est une distinction honorifique attribuée à une personnalité reconnue pour son expertise ou sa contribution, jouant un rôle de prestige, de conseil et de représentation sans responsabilité opérationnelle ou décisionnelle. Il agit comme ambassadeur pour renforcer la notoriété de l'institution lors d'événements clés.",
          photo: "/images/team/president-honneur.jpg",
        },
      ],
    },
    network: {
      title: "Notre réseau international",
      subtitle: "La CCNE-RDC est représentée dans 15 pays à travers le monde",
      countries: [
        "Zambie",
        "Canada",
        "Mexique",
    ...
    events: {
      ...
      items: [
        {
          name: "AFEX 2025 — Africa Business Forum & Expo",
    ...
    gallery: {
      ...
      subtitle: "Nos événements et réunions en images",
    },
    contact: {
    ...
    footer: {
      copyright:
        "© 2025 CCNE-RDC — Chambre de Commerce Nationale et de l'Économie de la RDC. Tous droits réservés.",
    },
  },
  en: {
    nav: {
    ...
    team: {
      ...
      members: [
        ...
        },
        {
          ...
          description:
            "The Honorary President is an honorary distinction awarded to a personality recognized for their expertise or contribution, playing a role of prestige, advice, and representation without operational or decision-making responsibility. He acts as an ambassador to strengthen the institution's reputation at key events.",
          photo: "/images/team/president-honneur.jpg",
        },
      ],
    },
    network: {
      ...
      subtitle: "The CCNE-RDC is represented in 15 countries worldwide",
      countries: [
        "Zambia",
        "Canada",
        "Mexico",
    ...
    gallery: {
      title: "Photo Gallery",
      subtitle: "Our events and meetings in pictures",
    },
    contact: {
      title: "Contact Us",
    ...
    footer: {
      copyright:
        "© 2025 CCNE-RDC — National Chamber of Commerce and Economy of the DRC. All rights reserved.",
    },
  },
} as const;
